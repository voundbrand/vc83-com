        ...
        <div className="retro-window window-corners w-full max-w-sm">
          ...
          <div className="retro-titlebar window-titlebar-corners px-2 py-1 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              >⚠️</div>
              <span className="font-pixel text-xs" style={{ color: 'var(--win95-titlebar-text)' }}>Error</span>
            </div>
          ...
          {/* Content */}
          <div className="p-6 text-center" style={{ background: 'var(--win95-bg)' }}>
      ...
      <div className="retro-window window-corners w-full max-w-md">
        ...
        <div className="retro-titlebar window-titlebar-corners px-2 py-1 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            >🍰</div>
            <span className="font-pixel text-xs" style={{ color: 'var(--win95-titlebar-text)' }}>CLI Login</span>
          </div>
          <div className="flex gap-[2px]">
            ...
            <>
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="px-2 retro-text-secondary" style={{ background: 'var(--win95-bg)' }}>or</span>
                </div>
              </div>
