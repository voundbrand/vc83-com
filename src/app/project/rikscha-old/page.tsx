...
// Using test data created by seedProjectDrawerTest
// ============================================
const PROJECT_CONFIG: ProjectDrawerConfig = {
  organizationId: "kn75f33b8xzr6ze0k865tq1bc17x5jq2" as Id<"organizations">,
  projectId: "q979a3t71z3hmt4x5g86qhtedn7ywkjz" as Id<"objects">,
  theme: "amber",
...
// ============================================
// COLOR SCHEME
// Primary Orange: #f0c142
// Browns: #8B4513 (saddle brown), #A0522D (sienna), #6B4423
// Dark Grey: #374151, #1f2937
// White background with warm accents
// ============================================
...
function PasswordProtection({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (password.toLowerCase() === "rikscha") {
        onCorrectPassword();
      } else {
        setError(true);
        setIsChecking(false);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-white border border-amber-200 shadow-xl shadow-amber-900/10 p-8">
          {/* Logo Area */}
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-amber-500 to-orange-600 text-white mb-4">
              <Bike className="w-8 h-8" />
            </div>
            <h1 className="text-2xl font-serif font-bold text-gray-800">
              Rikscha-Projekt Torgelow
            </h1>
            <p className="text-gray-500 text-sm mt-2">
              Marketingstrategie für Frank & Alex
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-amber-500 to-orange-600 text-white py-3 font-medium hover:from-amber-600 hover:to-orange-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isChecking ? (
                <>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 text-center">
            <p className="text-xs text-gray-400">
              Erstellt von{" "}
              <span className="text-amber-600 font-medium">Remington</span>
              {" - "}
              <a
                href="https://l4yercak3.com"
                target="_blank"
                rel="noopener noreferrer"
                className="text-amber-600 italic hover:text-amber-700 transition-colors"
              >
                l4yercak3 Studios
              </a>
            </p>
...
// ============================================
// MAIN PAGE CONTENT (wrapped by provider)
// ============================================

function RikschaPageContent() {
  return (
