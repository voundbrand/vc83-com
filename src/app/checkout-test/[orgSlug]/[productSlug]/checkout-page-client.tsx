...
export function CheckoutPageClient({ orgSlug, slug }: CheckoutPageClientProps) {
  ...
  // 🧪 TEST MODE: Force behavior-driven template
  const templateCode = "behavior-driven"; // Override to test new template
  const themeCode = (config.themeCode as string) || "modern-gradient";
  const settings = (config.settings as Record<string, unknown>) || {};

  console.log("🧪 [TEST MODE] Using behavior-driven checkout template");
