      ...
      <div>
        ...
        >
          <div className="flex-1">
            <span className="text-sm font-bold">📝 Detailed Description (Rich Text)</span>
            {description && (
    ...
    <div className="space-y-2">
      ...
      <div className="pl-4 space-y-3 border-l-2" style={{ borderColor: "var(--win95-border)" }}>
        <p className="text-xs" style={{ color: "var(--neutral-gray)" }}>
          Add rich formatting, links, and detailed information about your event
        </p>
        ...
        <SimpleTiptapEditor
          ...
          placeholder="Write a detailed description of your event. Include schedule, what attendees can expect, special guests, and any other important information..."
          minHeight="300px"
        />
