        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {isLoading ? (
            ...
            <>
              ...
              <div
                className="p-4 border-2 rounded text-xs space-y-2"
                style={{
                  borderColor: "var(--window-document-border)",
                  background: "var(--window-document-bg-elevated)",
              ...
              >
                <p className="font-bold">Slack App URLs</p>
                <p>
                  <span className="font-bold">OAuth Callback:</span> {callbackUrl}
                </p>
                <p>
                  <span className="font-bold">Events Request URL:</span> {eventsUrl}
                </p>
                <p>
                  <span className="font-bold">Slash Commands URL:</span>{" "}
                  {slashCommandsEnabled ? slashCommandsUrl : "Disabled (commands scope off)"}
                </p>
                <p>
                  <span className="font-bold">Response Mode:</span>{" "}
                  Threaded Slack messages reply in-thread; slash commands reply top-level.
                </p>
                <a
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <p className="text-xs" style={{ color: "var(--neutral-gray)" }}>
                  Connect your Slack workspace to enable app mention handling and outbound channel/thread replies.
                </p>
              </div>
