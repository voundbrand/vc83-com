 ...
 * 1. Frontend calls initiateInvoicePayment → validates and returns reference
  ...
  handler: async (ctx, args): Promise<{
    ...
    try {
      ...
      if (transactionType === "B2B" && !customerCompanyName) {
        console.warn("⚠️ [initiateInvoicePayment] B2B invoice requested but no company name provided");
      }
      ...
      console.log("✅ [initiateInvoicePayment] Invoice payment validated:", {
        invoiceReference,
        transactionType,
        customerEmail,
        customerCompanyName,
      ...
      console.error("❌ [initiateInvoicePayment] Invoice payment initiation failed:", error);
      return {
        success: false,
        requiresUserAction: false,
        status: "error",
