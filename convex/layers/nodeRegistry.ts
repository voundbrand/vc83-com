...
const lcNativeNodes: NodeDefinition[] = [
  ...
  },
  {
    ...
    name: "LC Booking Notifications",
    description: "Booking confirmation and reminder automation",
    category: "lc_native",
    subcategory: "email",
    icon: "lc_email",
    color: "#F59E0B",
    ...
    configFields: [
      { key: "action", label: "Action", type: "select", required: true, options: [
        { label: "Send Booking Reminders", value: "send-booking-reminders" },
      ]},
      { key: "reminderKind", label: "Reminder Type", type: "select", required: true, options: [
        { label: "Weather Reminder", value: "weather" },
        { label: "Packing List Reminder", value: "packing_list" },
      ]},
      { key: "daysBeforeStart", label: "Days Before Start", type: "number", defaultValue: 7 },
      { key: "recipientKinds", label: "Recipients (JSON Array)", type: "json", defaultValue: ["customer", "operator"] },
      { key: "bookingSubtypes", label: "Booking Subtypes (JSON Array)", type: "json", defaultValue: ["class_enrollment"] },
      { key: "bookingSources", label: "Booking Sources (JSON Array)", type: "json", defaultValue: ["segelschule_landing"] },
      { key: "operatorEmails", label: "Operator Emails (JSON Array)", type: "json" },
      { key: "weatherFallback", label: "Weather Fallback", type: "json" },
      { key: "timezone", label: "Timezone", type: "text", defaultValue: "Europe/Berlin" },
    ],
  },
  {
