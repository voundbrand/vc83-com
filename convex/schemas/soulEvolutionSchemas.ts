...
export const soulProposals = defineTable({
  ...
  workflowContractVersion: v.optional(v.string()),
  workflowSource: v.optional(v.string()),
  workflowState: v.optional(v.union(
    v.literal("pending_owner_approval"),
    v.literal("approved_pending_apply"),
    v.literal("applied_pending_verification"),
    v.literal("verified"),
    v.literal("rolled_back"),
    v.literal("blocked"),
  )),
  waeRecommendationPacketContractVersion: v.optional(v.string()),
  waeRecommendationId: v.optional(v.string()),
  waeRecommendationTarget: v.optional(v.union(v.literal("agent"), v.literal("prompt"))),
  waeRunId: v.optional(v.string()),
  waeSuiteKeyHash: v.optional(v.string()),
  waeBaselineSoulVersion: v.optional(v.number()),
  waeAutoRollbackOnRegression: v.optional(v.boolean()),
  waeApprovalCheckpointId: v.optional(v.string()),
  waeAppliedSoulVersion: v.optional(v.number()),
  waeVerificationSummary: v.optional(v.string()),
  waeRollbackTargetVersion: v.optional(v.number()),
