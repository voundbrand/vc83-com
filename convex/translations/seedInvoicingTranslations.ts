  ...
  handler: async (ctx) => {
    ...
    const invoicingWindow = {
      ...
      "ui.invoicing_window.create.title": {
        ...
        pl: "Utwórz nową fakturę",
        ja: "新しい請求書を作成",
      },
      "ui.invoicing_window.create.description": {
        en: "Create invoices for your B2B organizations or B2C customers from the CRM with automatic calculations.",
        de: "Erstellen Sie Rechnungen für Ihre B2B-Organisationen oder B2C-Kunden aus dem CRM mit automatischen Berechnungen.",
        es: "Cree facturas para sus organizaciones B2B o clientes B2C desde el CRM con cálculos automáticos.",
        fr: "Créez des factures pour vos organisations B2B ou clients B2C depuis le CRM avec des calculs automatiques.",
        pl: "Twórz faktury dla organizacji B2B lub klientów B2C z CRM z automatycznymi obliczeniami.",
        ja: "CRMからB2B組織またはB2C顧客の請求書を自動計算で作成します。",
      },
      ...
      "ui.invoicing_window.create.customer_type": {
        en: "Customer Type",
        de: "Kundentyp",
        es: "Tipo de cliente",
        fr: "Type de client",
      ...
      "ui.invoicing_window.create.type_b2b": {
        en: "Organization (B2B)",
        de: "Organisation (B2B)",
        es: "Organización (B2B)",
        fr: "Organisation (B2B)",
      ...
      "ui.invoicing_window.create.type_b2c": {
        en: "Individual (B2C)",
        de: "Einzelperson (B2C)",
        es: "Individual (B2C)",
        fr: "Particulier (B2C)",
        pl: "Osoba prywatna (B2C)",
        ja: "個人 (B2C)",
      },
      "ui.invoicing_window.create.select_organization": {
        en: "Select Organization",
        de: "Organisation auswählen",
        es: "Seleccionar organización",
        fr: "Sélectionner l'organisation",
      ...
      "ui.invoicing_window.create.select_contact": {
        en: "Select Contact",
        de: "Kontakt auswählen",
        es: "Seleccionar contacto",
        fr: "Sélectionner le contact",
        pl: "Wybierz kontakt",
        ja: "連絡先を選択",
      },
      "ui.invoicing_window.create.select_contact_placeholder": {
        en: "Choose an individual customer...",
        de: "Einzelkunden wählen...",
        es: "Elegir cliente individual...",
        fr: "Choisir un client particulier...",
        pl: "Wybierz klienta indywidualnego...",
        ja: "個人顧客を選択...",
      },
      "ui.invoicing_window.create.no_contacts": {
        en: "No individual customers found. Create contacts in the CRM first.",
        de: "Keine Einzelkunden gefunden. Erstellen Sie zuerst Kontakte im CRM.",
        es: "No se encontraron clientes individuales. Cree contactos en el CRM primero.",
        fr: "Aucun client particulier trouvé. Créez d'abord des contacts dans le CRM.",
        pl: "Nie znaleziono klientów indywidualnych. Najpierw utwórz kontakty w CRM.",
        ja: "個人顧客が見つかりません。まずCRMで連絡先を作成してください。",
      },
      "ui.invoicing_window.create.contact_info": {
      ...
      "ui.invoicing_window.create.name": {
        en: "Name",
        de: "Name",
        es: "Nombre",
        fr: "Nom",
      ...
      "ui.invoicing_window.create.email": {
        en: "Email",
        de: "E-Mail",
      ...
      "ui.invoicing_window.create.no_b2b_orgs": {
        en: "No organizations with billing information found. Please set up billing in the CRM first.",
        de: "Keine Organisationen mit Rechnungsinformationen gefunden. Bitte richten Sie zuerst die Rechnungsinformationen im CRM ein.",
        es: "No se encontraron organizaciones con información de facturación. Configure primero la información de facturación en el CRM.",
        fr: "Aucune organisation avec informations de facturation trouvée. Veuillez d'abord configurer les informations de facturation dans le CRM.",
        pl: "Nie znaleziono organizacji z informacjami rozliczeniowymi. Najpierw skonfiguruj informacje rozliczeniowe w CRM.",
        ja: "請求情報を持つ組織が見つかりません。まずCRMで請求情報を設定してください。",
      },
      ...
      "ui.invoicing_window.create.errors.no_organization_selected": {
        en: "Please select an organization",
        de: "Bitte wählen Sie eine Organisation",
        es: "Seleccione una organización",
        fr: "Veuillez sélectionner une organisation",
        pl: "Wybierz organizację",
        ja: "組織を選択してください",
      },
      "ui.invoicing_window.create.errors.no_contact_selected": {
        en: "Please select a contact",
        de: "Bitte wählen Sie einen Kontakt",
        es: "Seleccione un contacto",
        fr: "Veuillez sélectionner un contact",
        pl: "Wybierz kontakt",
        ja: "連絡先を選択してください",
      },
