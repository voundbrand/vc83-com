...
const TRANSLATIONS: ReadonlyArray<{ key: string; value: string }> = [
  ...
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.action_completion_mismatch", value: "Action completion mismatch" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.collapse", value: "Collapse" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.debug_artifact_rewrites", value: "Rewrite artifacts" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.debug_data_quality", value: "Data quality" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.debug_incident_count", value: "Returned incidents" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.debug_incident_line", value: "source={source} · template={template} · {channel} · {timeAgo}" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.debug_incident_source", value: "Incident source" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.debug_source_mode", value: "Source mode" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.debug_summary_source", value: "Summary source" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.diagnostic_mode", value: "Diagnostic mode" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.expand", value: "Expand" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.latest_incident_summary", value: "Latest incident: {reason} ({timeAgo})." },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.loading_action_completion_mismatch", value: "Loading mismatch telemetry..." },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.loading_diagnostic", value: "Loading diagnostic telemetry..." },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.mismatch_admin_diagnostic", value: "Admin mismatch diagnostic" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.mismatch_incidents", value: "Mismatch incidents" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.mismatch_rate", value: "Mismatch rate" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.no_verified_mismatch_incidents", value: "No verified mismatch incidents in this period." },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.rewrites_applied", value: "Rewrites applied" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.telemetry_coverage", value: "Telemetry coverage" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.top_mismatch_reason", value: "Top mismatch reason" },
  { key: "ui.agents.trust_cockpit.cards.runtime_kpis.unknown_channel", value: "unknown channel" },
];
