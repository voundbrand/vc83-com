...
export const seed = internalMutation({
  handler: async (ctx) => {
    ...
    const translations = [
      ...
      {
        key: "ui.tickets.list.button.cancel",
        values: {
          en: "Cancel",
          de: "Stornieren",
          pl: "Anuluj",
      ...
      {
        key: "ui.tickets.list.button.delete",
        values: {
          en: "Delete",
          de: "Löschen",
          pl: "Usuń",
      ...
      {
        key: "ui.tickets.list.confirm_cancel_title",
        values: {
          en: "Cancel Ticket",
      ...
      {
        key: "ui.tickets.list.confirm_cancel_message",
        values: {
          en: "Are you sure you want to cancel \"{name}\"?\n\nThis will mark the ticket as cancelled but it will remain in the system.",
          de: "Möchten Sie \"{name}\" wirklich stornieren?\n\nDies markiert das Ticket als storniert, aber es bleibt im System.",
          pl: "Czy na pewno chcesz anulować \"{name}\"?\n\nSpowoduje to oznaczenie biletu jako anulowanego, ale pozostanie w systemie.",
          es: "¿Estás seguro de que deseas cancelar \"{name}\"?\n\nEsto marcará la entrada como cancelada, pero permanecerá en el sistema.",
          fr: "Êtes-vous sûr de vouloir annuler \"{name}\" ?\n\nCela marquera le billet comme annulé, mais il restera dans le système.",
          ja: "\"{name}\"をキャンセルしてもよろしいですか？\n\nこれによりチケットはキャンセル済みとしてマークされますが、システムに残ります。",
        },
      },
      {
        key: "ui.tickets.list.confirm_delete_title",
        values: {
          en: "Delete Ticket",
          de: "Ticket löschen",
          pl: "Usuń bilet",
          es: "Eliminar entrada",
          fr: "Supprimer le billet",
          ja: "チケットを削除",
        },
      },
      {
        key: "ui.tickets.list.confirm_delete_message",
        values: {
          en: "Are you sure you want to permanently delete \"{name}\"?\n\nThis action cannot be undone!",
          de: "Möchten Sie \"{name}\" wirklich dauerhaft löschen?\n\nDiese Aktion kann nicht rückgängig gemacht werden!",
          pl: "Czy na pewno chcesz trwale usunąć \"{name}\"?\n\nTej operacji nie można cofnąć!",
          es: "¿Estás seguro de que deseas eliminar permanentemente \"{name}\"?\n\n¡Esta acción no se puede deshacer!",
          fr: "Êtes-vous sûr de vouloir supprimer définitivement \"{name}\" ?\n\nCette action ne peut pas être annulée !",
          ja: "\"{name}\"を完全に削除してもよろしいですか？\n\nこの操作は元に戻せません！",
        },
      },
      {
        key: "ui.tickets.list.confirm_redeem_title",
        values: {
          en: "Redeem Ticket",
          de: "Ticket einlösen",
          pl: "Zrealizuj bilet",
          es: "Canjear entrada",
          fr: "Échanger le billet",
          ja: "チケットを引き換え",
        },
      },
      {
        key: "ui.tickets.list.confirm_redeem_message",
        values: {
          en: "Mark \"{name}\" as redeemed (checked in)?",
          de: "\"{name}\" als eingelöst (eingecheckt) markieren?",
          pl: "Oznaczyć \"{name}\" jako zrealizowany (zameldowany)?",
          es: "¿Marcar \"{name}\" como canjeada (registrada)?",
          fr: "Marquer \"{name}\" comme échangé (enregistré) ?",
          ja: "\"{name}\"を引き換え済み（チェックイン）としてマークしますか？",
        },
      },
      {
