...
export const seed = internalMutation({
  ...
  handler: async (ctx) => {
    ...
    const translations = [
      ...
      { key: "ui.workflows.card.menu.confirmArchive", values: { en: "Are you sure you want to archive this workflow?", de: "Möchten Sie diesen Workflow wirklich archivieren?", es: "¿Está seguro de que desea archivar este flujo?", fr: "Êtes-vous sûr de vouloir archiver ce flux ?", ja: "このワークフローをアーカイブしてもよろしいですか？", pl: "Czy na pewno chcesz zarchiwizować ten przepływ?" } },
      { key: "ui.workflows.card.menu.deletePermanently", values: { en: "Delete Permanently", de: "Dauerhaft löschen", es: "Eliminar Permanentemente", fr: "Supprimer Définitivement", ja: "完全に削除", pl: "Usuń na Stałe" } },
      { key: "ui.workflows.card.menu.confirmDelete", values: { en: "Are you sure you want to delete this workflow? This action cannot be undone.", de: "Möchten Sie diesen Workflow wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden.", es: "¿Está seguro de que desea eliminar este flujo? Esta acción no se puede deshacer.", fr: "Êtes-vous sûr de vouloir supprimer ce flux ? Cette action ne peut pas être annulée.", ja: "このワークフローを削除してもよろしいですか？この操作は元に戻せません。", pl: "Czy na pewno chcesz usunąć ten przepływ? Tej akcji nie można cofnąć." } },
      { key: "ui.workflows.card.menu.confirmPermanentDelete", values: { en: "Are you sure you want to PERMANENTLY delete this workflow? This cannot be undone!", de: "Möchten Sie diesen Workflow wirklich DAUERHAFT löschen? Dies kann nicht rückgängig gemacht werden!", es: "¿Está seguro de que desea ELIMINAR PERMANENTEMENTE este flujo? ¡Esto no se puede deshacer!", fr: "Êtes-vous sûr de vouloir SUPPRIMER DÉFINITIVEMENT ce flux ? Cela ne peut pas être annulé !", ja: "このワークフローを完全に削除してもよろしいですか？元に戻すことはできません！", pl: "Czy na pewno chcesz NA STAŁE usunąć ten przepływ? Tego nie można cofnąć!" } },
