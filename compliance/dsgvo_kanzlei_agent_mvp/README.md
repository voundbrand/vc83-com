...
- `AVV_PROVIDER_COLLECTION_RUNBOOK.md` - operativer Sammelablauf je Provider (Download -> lokale Ablage -> Vault Upload -> Dossier-Link)
...
- `provider_dossiers/` - lokale Intake-Ablage pro Anbieter vor manuellem Vault-Upload
