...
|---|---|---|---|---|
| Contract (AVV/DPA) | 2026-03-27_vercel_analytics_dpa.html | https://vercel.com/legal/dpa | 2026-03-27 | Public source captured; replace/augment with account-level acceptance proof. |
| Subprocessors | 2026-03-27_vercel_analytics_security_center.html | https://security.vercel.com/ | 2026-03-27 | Public source captured where available. |
...
| Intake proof | MISSING | account portal / email thread screenshot | MISSING | Confirm in-scope usage and capture account-level acceptance proof in intake/. |
