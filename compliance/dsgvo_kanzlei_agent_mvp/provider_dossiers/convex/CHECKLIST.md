...
|---|---|---|---|---|
| Contract (AVV/DPA) | 2026-03-27_convex_dpa.html | https://www.convex.dev/legal/dpa | 2026-03-27 | Public source captured; replace/augment with account-level acceptance proof. |
| Subprocessors | 2026-03-27_convex_subprocessors.html | https://www.convex.dev/legal/subprocessors | 2026-03-27 | Public source captured where available. |
...
| Intake proof | MISSING | account portal / email thread screenshot | MISSING | Capture Convex account-level DPA acceptance state screenshot in intake/. |
