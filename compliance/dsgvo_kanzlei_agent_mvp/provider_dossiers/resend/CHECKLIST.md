...
|---|---|---|---|---|
| Contract (AVV/DPA) | 2026-03-27_resend_dpa.html | https://resend.com/legal/dpa | 2026-03-27 | Public source captured; replace/augment with account-level acceptance proof. |
| Subprocessors | 2026-03-27_resend_subprocessors.html | https://resend.com/legal/subprocessors | 2026-03-27 | Public source captured where available. |
...
| Intake proof | MISSING | account portal / email thread screenshot | MISSING | Capture Resend org-level acceptance and any deletion/incident commitments in intake/. |
