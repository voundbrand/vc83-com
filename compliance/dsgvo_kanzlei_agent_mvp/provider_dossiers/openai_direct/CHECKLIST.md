...
|---|---|---|---|---|
| Contract (AVV/DPA) | 2026-03-27_openai_direct_dpa.html | https://openai.com/policies/data-processing-addendum/ | 2026-03-27 | Public source captured; replace/augment with account-level acceptance proof. |
| Subprocessors | 2026-03-27_openai_direct_subprocessors.html | https://openai.com/policies/sub-processor-list/ | 2026-03-27 | Public source captured where available. |
| Transfer basis | 2026-03-27_openai_direct_services_agreement.html | https://openai.com/policies/services-agreement/ | 2026-03-27 | Add SCC/DPF/TIA evidence linked to your tenant/account. |
| TOM / Security | MISSING | MISSING | 2026-03-27 | Add tenant-specific security attestation if required. |
| Intake proof | MISSING | account portal / email thread screenshot | MISSING | Capture account-level applicability/acceptance proof for the OpenAI DPA in intake/. |
