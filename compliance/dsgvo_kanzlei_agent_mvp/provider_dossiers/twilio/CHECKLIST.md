...
|---|---|---|---|---|
| Contract (AVV/DPA) | 2026-03-27_twilio_dpa.html | https://www.twilio.com/en-us/legal/data-protection-addendum | 2026-03-27 | Public source captured; replace/augment with account-level acceptance proof. |
| Subprocessors | 2026-03-27_twilio_subprocessors.html | https://www.twilio.com/en-us/legal/sub-processors | 2026-03-27 | Public source captured where available. |
| Transfer basis | MISSING | MISSING | 2026-03-27 | Add SCC/DPF/TIA evidence linked to your tenant/account. |
| TOM / Security | 2026-03-27_twilio_security_overview.html | https://www.twilio.com/legal/security-overview | 2026-03-27 | Add tenant-specific security attestation if required. |
| Intake proof | MISSING | account portal / email thread screenshot | MISSING | Capture tenant-level DPA acceptance and product scope (Twilio/SendGrid) in intake/. |
