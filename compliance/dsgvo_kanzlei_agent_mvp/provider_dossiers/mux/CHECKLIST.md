...
|---|---|---|---|---|
| Contract (AVV/DPA) | 2026-03-27_mux_dpa_page.html; 2026-03-27_mux_dpa_pdf.pdf | https://www.mux.com/dpa ; https://www.mux.com/files/mux-dpa.pdf | 2026-03-27 | Public source captured; replace/augment with account-level acceptance proof. |
...
| Intake proof | MISSING | account portal / email thread screenshot | MISSING | Capture Mux signed/accepted DPA proof tied to your account in intake/. |
