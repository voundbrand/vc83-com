...
### The Three-Layer Context Model Extended

The existing Three-Layer Context Model (Layer 1: Platform, Layer 2: Agency, Layer 3: Client) maps directly:

- **Layer 1 (Platform)** provides: system knowledge + recipes + skills
- **Layer 2 (Agency)** provides: org RAG knowledge + agent config + brand voice
- **Layer 3 (Client)** receives: composed automations that the agency deploys
