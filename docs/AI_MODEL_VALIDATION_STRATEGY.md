...
5. [CLI Testing Tool](#cli-testing-tool)
...
Each model undergoes **5 critical tests** that simulate real-world usage:
...
Expected Parameters: { query: "Alice Smith", department: "sales" }
```

**Pass Criteria:**
- ✅ Correct tool called
- ✅ Query parameter extracted ("Alice Smith")
...
- Tests run in order (1 → 2 → 3 → 4 → 5)
- Total time per model: ~90-120 seconds
...
```css
✓ Tested       → Green (#10B981)   → All 5 tests passed
...
- `testResults` object (5 boolean fields)
...
- [AI Model Management Guide](./AI_MODEL_MANAGEMENT.md)
- [Tool Calling Documentation](./AI_TOOL_CALLING_GUIDE.md)
