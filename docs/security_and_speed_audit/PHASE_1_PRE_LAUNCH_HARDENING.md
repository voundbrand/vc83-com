...
| `docs/reference_docs/topic_collections/byok_infra/BYOK_INFRASTRUCTURE_AUDIT.md` | OpenRouter API key (`sk-or-v1-...`) |
| `docs/reference_docs/api/ai-webhook-setup.md` | Webhook secrets |
...
- [OpenClaw Pattern Integration](../platform/OPENCLAW_IDEA_INTEGRATION.md) — integrated OpenClaw guardrails research (Section 5)
