...
When building apps following the [App Development Guide](../../platform/ARCHITECTURE.md):
...
For more details on building apps, see [App Development Guide](../../platform/ARCHITECTURE.md).

For overall design patterns, see [Design Guidelines](../../platform/LAYERS_PRD.md).
