...
- `docs/reference_docs/frontend/frontend-oauth-setup.md` - Frontend implementation guide
...
- `docs/reference_docs/api/microsoft-oauth-error-handling.md` - Error handling

### Frontend OAuth (Customers)
- `docs/reference_docs/frontend/frontend-oauth-setup.md` - **Complete setup guide** ⭐
- `docs/reference_docs/api/api-data-flow-diagram.md` - Data flow overview
