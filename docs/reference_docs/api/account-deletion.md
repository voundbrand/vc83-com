...
**Restore Button:**
- **File**: `src/components/window-content/manage-window/user-edit-modal.tsx` (legacy path)
...
3. Documentation ✅
docs/reference_docs/api/account-deletion.md - Comprehensive guide:
...
Documentation:
✅ docs/reference_docs/api/account-deletion.md - NEW: Complete guide
