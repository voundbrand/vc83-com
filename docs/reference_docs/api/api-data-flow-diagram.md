...
- **[API_PAYLOAD_STRUCTURE.md](./api-payload-structure.md)** ⭐ Complete spec
- **[FRONTEND_BACKEND_INTEGRATION_SUMMARY.md](../FRONTEND_BACKEND_INTEGRATION_SUMMARY.md)** Quick reference
- **[FRONTEND_CHECKOUT_INTEGRATION.md](../frontend/frontend-checkout-integration.md)** Integration guide
