...
- **docs/reference_docs/api/payment-api-integration.md** - Complete integration guide
- **docs/reference_docs/api/api-payment-solution.md** - This architecture document
...
- **Documentation**: [docs/reference_docs/api/payment-api-integration.md](./payment-api-integration.md)
