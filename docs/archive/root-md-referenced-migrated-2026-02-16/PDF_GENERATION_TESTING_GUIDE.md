...
- **Migration Guide:** [docs/API_TEMPLATE_IO_MIGRATION.md](./API_TEMPLATE_IO_MIGRATION.md)
- **Phase 2 Status:** [docs/PHASE_2_TICKET_PDF_MIGRATION_STATUS.md](./PHASE_2_TICKET_PDF_MIGRATION_STATUS.md)
