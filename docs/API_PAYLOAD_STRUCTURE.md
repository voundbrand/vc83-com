...
- [FRONTEND_CHECKOUT_INTEGRATION.md](./FRONTEND_CHECKOUT_INTEGRATION.md)
- [SESSION_HANDOFF_CHECKOUT_ENHANCEMENT.md](./reference_docs/SESSION_HANDOFF_CHECKOUT_ENHANCEMENT.md)
