...
export const ENV = {
  ...
  VOICE_CHAOS_JITTER_MS: Number(process.env.EXPO_PUBLIC_VOICE_CHAOS_JITTER_MS || 0),
  VOICE_CHAOS_FORCE_PROVIDER_TIMEOUT:
    process.env.EXPO_PUBLIC_VOICE_CHAOS_FORCE_PROVIDER_TIMEOUT === 'true',
  VIDEO_TRANSPORT_MODE:
    process.env.EXPO_PUBLIC_VIDEO_TRANSPORT_MODE || 'http_bridge',
  VIDEO_WEBSOCKET_URL: process.env.EXPO_PUBLIC_VIDEO_WEBSOCKET_URL || '',
  VIDEO_CAPTURE_CADENCE_MS: Number(process.env.EXPO_PUBLIC_VIDEO_CAPTURE_CADENCE_MS || 750),
  VIDEO_MAX_FRAMES_PER_WINDOW: Number(process.env.EXPO_PUBLIC_VIDEO_MAX_FRAMES_PER_WINDOW || 48),
  VIDEO_FRAME_WINDOW_MS: Number(process.env.EXPO_PUBLIC_VIDEO_FRAME_WINDOW_MS || 60000),
  META_BRIDGE_PERSISTED_EVENT_LIMIT:
    Number(process.env.EXPO_PUBLIC_META_BRIDGE_PERSISTED_EVENT_LIMIT || 2000),
  META_BRIDGE_MAX_PERSISTED_BYTES:
    Number(process.env.EXPO_PUBLIC_META_BRIDGE_MAX_PERSISTED_BYTES || 1500000),
  ...
  META_BRIDGE_UPLOAD_BATCH_SIZE:
    Number(process.env.EXPO_PUBLIC_META_BRIDGE_UPLOAD_BATCH_SIZE || 100),
  META_BRIDGE_UPLOAD_MAX_FREQUENCY_MS:
    Number(process.env.EXPO_PUBLIC_META_BRIDGE_UPLOAD_MAX_FREQUENCY_MS || 60000),
  META_BRIDGE_UPLOAD_BASE_BACKOFF_MS:
