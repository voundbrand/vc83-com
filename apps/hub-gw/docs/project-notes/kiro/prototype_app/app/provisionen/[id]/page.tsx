...
import { ArrowLeft, Mail, Phone, TrendingUp, ExternalLink, Building2, User } from 'lucide-react'
...
const mockCommissions = [
  ...
  },
  {
    ...
    providerType: "startup" as const,
    profileLink: "https://gruendungswerft.com/members/weber-marketing",
    process: [
  ...
  },
  {
    ...
    providerType: "startup" as const,
    profileLink: "https://gruendungswerft.com/members/startup-hub",
    process: [
  ...
  },
  {
    ...
    providerType: "person" as const,
    profileLink: "https://gruendungswerft.com/members/thomas-klein",
    process: [
  ...
  },
  {
    ...
    providerType: "person" as const,
    profileLink: "https://gruendungswerft.com/members/julia-fischer",
    process: [
  ...
  },
  {
    ...
    providerType: "startup" as const,
    profileLink: "https://gruendungswerft.com/members/content-agency",
    process: [
          ...
          <div className="space-y-6">
            <Card className="sticky top-6">
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-1 text-sm text-muted-foreground">
                      {commission.providerType === 'startup' ? (
                        <>
                ...
                {commission.profileLink && (
                  <Button variant="outline" className="w-full justify-start gap-2" asChild>
                    <a href={commission.profileLink} target="_blank" rel="noopener noreferrer">
